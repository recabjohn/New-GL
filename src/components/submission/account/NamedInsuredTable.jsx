    ...
    <>
      ...
      >
        {insureds.length === 0 ? (
          <div className="py-3 text-center">
            <Building2 className="h-5 w-5 text-stone-300 mx-auto mb-1" />
            <p className="text-xs text-stone-400">No additional named insureds</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-stone-100">
                  ...
                  {['Insured Name', 'Legal Entity Name / DBA', 'Full Address', 'Entity Type', ''].map(h => (
              ...
              <tbody className="divide-y divide-stone-50">
                {insureds.map(ins => (
                  <tr key={ins.id} className="group hover:bg-stone-25">
                    ...
                    <td className="py-2.5 pr-4 text-stone-500 max-w-[200px] truncate">{ins.fullAddress || '—'}</td>
                    <td className="py-2.5 pr-4 text-stone-500">{ins.entityType || '—'}</td>
                    <td className="py-2.5">
      ...
      >
        <div className="space-y-4">
          <Input label="Insured Name" required value={form.name} onChange={e => set('name', e.target.value)} error={errors.name} />
